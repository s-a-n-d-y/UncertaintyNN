...
def dropout_evaluation(x, y, dropout, learning_rate, epochs, n_passes, ax, display_step=2000):
    # Hardcoded training dropout

    dropout_model = dropout_training(x, y, 0.2, learning_rate, epochs, display_step=display_step)
    ...
    for _ in range(n_passes):
        predictions.append(dropout_model(x_eval))
...
def dropout_evaluation_old(x, y, dropout, learning_rate, epochs, n_passes, ax):
    # Hardcoded training dropout
